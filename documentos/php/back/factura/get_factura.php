...
if (function_exists('verificar_session') && verificar_session() == true) :
    ...
    $f = array();
    if($u->hasPrivilege(302) || $u2->accesoModulo(7851) || $u->hasPrivilege(324)){
      ...
      $data = array(
        ...
        'isValidPedTra'=>(!empty($f['ped_tra']) || $f['ped_tra'] > 0) ? false : true,
        'direccion'=>$direccion
        //'tecnico'=>$f['tecnico']
      ...
      createLog(318, 8017,  'docto_ped_pago','Visualizando detalle de la Factura = id_factura:'.$f['orden_compra_id'].' No. Factura: '.$f['factura_num'],'', '');
