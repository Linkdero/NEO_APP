...
if (function_exists('verificar_session') && verificar_session() == true) :
    ...
    if($compras_jefe == true || $compras_tecnico == true || $presupuesto_au == true || $presupuesto == true || $subdirectorfinanciero == true){
      $ordenes = $clased->get_ordenes_group_pendientes($tipo,$year,$privilegio);
    }
    ...
    foreach ($ordenes as $orden) {
      ...
      //if(!empty($orden['id_tipo_pago'])){
        ...
        if(($compras_jefe == true || $compras_au == true) && ($orden['id_bitacora'] == 1 || ($orden['id_bitacora'] == 3 && $orden['id_seguimiento'] == 13)) && $type == 0){
