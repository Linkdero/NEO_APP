...
if (function_exists('verificar_session') && verificar_session() == true) :
    ...
    if ($u->hasPrivilege(302) && $u->hasPrivilege(325) || $u->hasPrivilege(301) && $u->hasPrivilege(325)) {
      $pac_list = $clased->get_pac_by_ejercicio($id_direccion,$year);
      ...
      //echo $depto;
      $pac_list = $clased->get_pac_by_ejercicio($depto,$year);
      //echo $dir;
    }
    ...
    foreach($pac_list as $p){
      ...
      $estado.= ($p['pac_consolidado_status'] == 1) ? ' - CONSOLIDADO' : '';
      ...
      $sub_array = array(
        ...
        'estado'=>$estado,
        'status_chk'=>($p['id_status'] == 1 || $p['id_status'] == 4 || $p['id_status'] == 5 || $p['pac_consolidado_status'] == 1) ? 2 : 1,
      );
      $data[] = $sub_array;
    }
