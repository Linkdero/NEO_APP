...
<head>
  ...
  <script src="documentos/js/pedido_vue_detalle_1.7.js"></script>
...
<div id="app_pedido_detalle" style="-webkit-transform: translateZ(0);">
    ...
    <ul class="list-inline ml-auto mb-0">
      <div class="btn-group btn-group-toggle" data-toggle="buttons">
        ...
        <!--<label class="btn btn-personalizado btn-sm" @click="getOpcion(4)" >
          <input type="radio" name="options" id="option4" autocomplete="off" > Facturas
        </label>-->
        <label v-if="privilegio.plani_au == true" class="btn btn-personalizado btn-sm" @click="getOpcion(6)" >
          <input type="radio" name="options" id="option6" autocomplete="off" > Vista Previa
        </label>
        <label class="btn btn-personalizado btn-sm" @click="getOpcion(5)">
          <input type="radio" name="options" id="option5" autocomplete="off"> Documentos
        </label>
        <label class="btn btn-personalizado btn-sm" @click="getOpcion(7)">
          <input type="radio" name="options" id="option5" autocomplete="off"> Acta
        </label>
    ...
    <div class="row">
      ...
      <div class="col-sm-12" v-show="opcion==1">
        <div class="row">
          ...
          <div class="col-sm-12">
            <insumos :ped_tra="ped_tra" :pedido="pedido"></insumos>
          </div>
      ...
      <!-- fin detalle -->
      <!-- inicio seguimiento -->
      <div class="col-sm-12" v-show="opcion==2" :pedido="pedido">
        <div class="row">
          <!-- inicio -->
          ...
          <div class="col-sm-12" v-if="estado.verificacion == 1010">
          <personas-direccion :pedido="pedido" :verificacion="estado.verificacion" :titulo="estado.titulo"></personas-direccion>
          </div>

          <!-- inicio -->
          <div class="col-sm-12" v-if="estado.verificacion == 2 || estado.verificacion == 6 || estado.verificacion == 7777">
            <br>
          ...
          <div class="col-sm-12" v-if="estado.verificacion == 10">
            ...
            <span class="btn btn-warning btn-sm btn-estado" @click="asignar_estado_pedido(9109,2)"><i class="fa fa-check"></i> Solicitar a SAA token para rechazar</span>
          </div>
          <!-- fin -->
          <!-- inicio -->
          <div class="col-sm-12" v-if="estado.verificacion_s == 999">
            <br>
      ...
      <div class="col-sm-12" v-show="opcion == 5">
        <documentos-respaldo-pedido :ped_tra="ped_tra" :pedido="pedido" :privilegio="privilegio"></documentos-respaldo-pedido>
      </div>
      <!-- inicio documentos -->
      <div class="col-sm-12" v-show="opcion == 7">
        <acta-pedido :ped_tra="ped_tra" :pedido="pedido" :privilegio="privilegio"></acta-pedido>
      </div>
      <div class="col-sm-12" v-show="opcion == 6">
        <iframe id="pdf_preview_vd" style="width:100%; height:450px"></iframe>
      </div>
      <!-- fin documentos -->
      <!-- fin documentos -->
  </div>
