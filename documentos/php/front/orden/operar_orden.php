...
<head>
  ...
  <script src="documentos/js/orden/viewModelOrden.js" ></script>
...
<div id="app_orden">
  ...
  <div class="modal-body" >
    ...
    <div class="row">
      <div class="col-sm-12">
        <ordenes-seleccionadas :arreglo="arreglo" tipo="2"></ordenes-seleccionadas>
      </div>
    ...
    <form v-if="tipo == 0 || tipo == 1" class="jsValidacionOrdenOperar" id="formValidacionOrdenOperar">
      ...
      <input type="text" id="id_pago" name="id_pago" value="<?php echo $id_pago?>" hidden></input>
      <div class="row">
