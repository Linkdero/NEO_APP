...
<head>
  ...
  <script src="documentos/js/facturas/facturanuevav1.7.js" ></script>
...
<div id="app_factura_n">
  <div class="modal-header">
    ...
    <ul class="list-inline ml-auto mb-0">
      <li class="list-inline-item close_fac_nueva" data-toggle="tooltip" title="Cerrar">
    ...
    <div v-show="sopcion == 1">
      <form class="jsValidacionFacturaNueva" id="formValidacionFacturaNueva">
        ...
        <div class="row">
          ...
          <!-- fin -->
          <!--inicio-->
          <div class="col-sm-6" v-if="ingresoTipo == 1">
            <div class="form-group">
              <div class="">
                <div class="">
          ...
          <!--inicio-->
          <div class="col-sm-6" v-if="ingresoTipo == 1 || ingresoTipo == 3 || ingresoTipo == 4">
            <div class="form-group">
              <div class="">
                <div class="">
          ...
          <!-- fin -->
          <!--inicio-->
          <div class="col-sm-6" v-if="tipoOperacion == 1">
            <div class="form-group">
              <div class="">
                <div class="">
                ...
                <div class="">
                  ...
                  <div class=" input-group  has-personalizado" >
                    <select class="form-control form-control-sm" style="width:100%" id="id_modalidad" name="id_modalidad" @change="validarNog($event)" required>
                      ...
                      <option value="3" v-if="privilegio.compras_recepcion == true || privilegio.compras_tecnico == true">Servicios </option>
                    </select>
                  </div>
                </div>
              </div>
          ...
          <!-- fin -->
          <!--inicio-->
          <div class="col-sm-6"  v-if="(privilegio.compras_recepcion == true || privilegio.compras_tecnico == true) && tipoOperacion == 1">
            <div class="form-group">
              <div class="">
                <div class="">
          ...
          <!--inicio-->
          <div :class="[(privilegio.compras_recepcion == true || privilegio.compras_tecnico == true) ? 'col-sm-6' : 'col-sm-12']" v-if="(ingresoTipo == 1 || ingresoTipo == 2) && tipoOperacion == 1">
            <div class="form-group">
              <div class="">
                <div class="">
          ...
          <div class="col-sm-12" v-if="idRenglon == 211 && isBajaCuantia == true">
            Ingresar Insumos

            <filter-insumos id_filtrado="filter_insumos" tipo="1" :evento="evento"></filter-insumos>
            <insumos-filtrado id_filtrado="filter_insumos" :evento="evento"></insumos-filtrado>
          </div>
