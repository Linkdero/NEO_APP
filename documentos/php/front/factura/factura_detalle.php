...
<head>
  ...
  <script src="documentos/js/facturas/modelFacturaDetalle1.3.js" ></script>
...
<div id="app_factura" style="-webkit-transform: translateZ(0);">
  ...
  <div class="modal-body">
    ...
    <input id="orden_id_" value="<?php echo $orden_id?>" hidden></input>
    <div>
      <div>
        <div class="row">
      ...
      <div v-else>
        ...
        <div v-if="insumosf.length > 0">
          <form class="jsValidacionFacturaInsumos">
            <div class="row">
              <pedidos-por-estado estado="0" v-if="factura.isValidPedTra == true" columna="col-sm-12" id="id_ped_tra" label="Pedidos en cotización" multiple="" is_multiple="false"></pedidos-por-estado>
              <div class="col-sm-12">
                <table class="table table-sm table-bordered table-striped">
                  <thead>
                    ...
                    <th class="text-center" style="width:15px">Costo</th>
                    <th class="text-center" style="width:15px">Importe</th>
                  </thead>
                  <tbody>
                    <tr v-for="i in insumosf">
                      ...
                      <td class="text-center">{{i.Ppr_costo}}</td>
                      <td class="text-center">{{i.Ppr_importe}}</td>

                      <td class="text-center" v-if="i.Ped_tra.length == 0" style="width:70px">
              ...
              <div class="col-sm-12 text-right" v-if="factura.isValidPedTra == true">
                <button class="btn btn-info" @click="agregarInsumosFactura($event,2)"><i class="fa fa-check-circle"></i> Guardar</button>
              </div>
            </div>
          </form>
        </div>
        <div v-else>
          <div class="row" v-if="privilegio.compras_tecnico_factura == true || privilegio.tesoreria_recepcion == true || privilegio.compras_recepcion == true">
            <div class="col-sm-2">
              ...
              <form class="jsValidacionFacturaInsumos">
                ...
                <div class="row">
                        ...
                        <tr v-for="(i, index) in insumos">
                          ...
                          <td class="text-center" style="width:60px">
                            <div class="form-group" v-if="i.checked==true" style="margin-bottom:0rem">
                              <div class="">
                                <div class="">
                                  <input type="number"  :name="i.id_precio" :id="i.id_precio"  class="form-control input-sm" v-model="i.precio_unitario" autocomplete="off" min="0.1" required></input>
                                </div>
                              </div>
                            </div>
                          </td>
                  ...
                  <div class="col-sm-12 text-right">
                    <button class="btn btn-sm btn-info" @click="agregarInsumosFactura($event,1)"><i class="fa fa-plus-circle"></i> Guardar</button>
