...
?>
    ...
    <script type="module" src="documentos/js/insumos/fraccionamiento/appInsumosFraccionamiento.js"></script>
    ...
    <div class="u-content">
        <div class="u-body" id="appInsumosFrac">
                  ...
                  <div class="tab-content">
                    <div id="insumoslist" class="tab-pane fade show active" role="tabpanel">
                      ...
                      <div class="table-responsive">
                        <div class="col-sm-6" style="position:absolute;z-index:2;margin-top:-15px">
                          <div class="row">
                            <div class="col-sm-4">
                              Año:
                              <select class="form-control form-control-sm" id="id_year_c" name="id_year_c" @change="recargarFraccionamiento()">
                            ...
                            <div class="col-sm-4">
                              Cuatrimestre:
                              <select class="form-control form-control-sm" id="id_cuatrimestre" name="id_cuatrimestre" @change="recargarFraccionamiento()">
                        ...
                        <table id="tb_insumos_frac" class="table table-actions table-striped table-bordered  " width="100%">
                          <thead>
                            <tr>
