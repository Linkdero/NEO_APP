...
?>
    ...
    <script src="assets/js/plugins/jspdf/documentos/impresiones.js"></script>
        ...
        <div class="u-body">
            <div class="card mb-4 ">
                <header class="card-header d-md-flex align-items-center">
                    <h2 class="h3 card-header-title" >Control de Justificaciones</h2>
                    <ul class="list-inline ml-auto mb-0">
                      ...
                      <?php //if(usuarioPrivilegiado()->hasPrivilege(1)){?>
                        <li class="list-inline-item"  title="Nuevo Nombramiento">
                          <span class="link-muted h3" data-toggle="modal" data-target="#modal-remoto" href="documentos/php/front/justificacion/justificacion_nueva.php">
                          ...
                          <div class="dropdown-menu dropdown-menu-right border-0 py-0 mt-3 slide-up-fade-in" style="width: 260px;" aria-labelledby="actions1Invoker" style="margin-right:20px">
                            <div class="card overflow-hidden" style="margin-top:-f;">
                              <div class="card-header d-flex align-items-center py-3">
                                <h2 class="h4 card-header-title" onclick="recargar_justificaciones()"><i class="fa fa-table"></i> Ver Pendientes:</h2>
                              </div>
                  ...
                  <div class="tab-content">
                    <div id="nombramientos" class="tab-pane fade show active" role="tabpanel">
                      <div class="table-responsive">
                        ...
                        <table id="tb_justificaciones" class="table table-actions table-striped table-bordered responsive nowrap" width="100%">
                          <thead>
                            <tr>
