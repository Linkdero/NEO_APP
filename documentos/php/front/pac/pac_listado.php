...
?>
    ...
    <script src="documentos/js/pac/pac.1.4.js"></script>
              ...
              <div class="card-body" id="app_pac">
                ...
                <div class="tab-content">
                  <div class="tab-pane fade show active slide_up_anim" id="panelWithTabsTab1" role="tabpanel">
                    ...
                    <div v-if="privilegio.compras == true" id="botonesP" class=" btn-group-toggle btn-group text-left" data-toggle="buttons" style="width:100%" >

                      <span  data-tooltip="Consolidar PAC" class="alerta_no tooltip_noti btn btn-sm btn-outline-info btn-facts-proceso text-left btn-fact" @click="cargarInput(2)"><i class="fa fa-edit"></i></span>

                    </div>
                    <br><br><br><br>
                      <input type="text" id="id_tipo_filtro" value="0" hidden></input>

                      <div class="col-sm-3" style="position:absolute; margin-top:-25px; z-index:5">
                        <div class="row">
                          <?php
                    ...
                    <table id="tb_pac" class="table-p table table-actions table-striped table-bordered  " width="100%">
                      <thead>
                        <tr>
                    ...
                    <div>
                      <form class="jsValidacionPacNuevo form-material" id="formValidacionPacNuevo">
                        <div class="row">
                          ...
                          <meses-listado columna="col-sm-3" label="Mes de compra:*" v-on:send_months="recibirMeses" tipo="1"></meses-listado>
                          <!--inicio-->
                          <div class="col-sm-12">
