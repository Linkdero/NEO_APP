  ...
  const viewModelInsumos = new Vue({
    ...
    methods: {
      getInsumos: function(){
        ...
        this.tableInsumos = $('#tb_inventario').DataTable({
          "ordering": false,
          "pageLength": 25,
          "bProcessing": true,
          //"paging":true,
          ...
          ajax:{
            url :"inventario/model/insumos.php",
            type: "POST",
            data:{
              opcion:1,
          ...
          buttons: [
            ...
            },*/
            {
              ...
              className: 'btn btn-soft-info btn-sm btn-v1 btn-via',
              action: function ( e, dt, node, config ) {
                viewModelInsumos.recargarInsumos();
              }
            },
          ]
        });
