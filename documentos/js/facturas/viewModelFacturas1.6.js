      ...
      table_ordenes: function () {
        ...
        setTimeout(() => {
          ...
          this.tableOrdenes = $('#tb_ordenes').DataTable({
            ...
            ajax: {
              url: "documentos/php/back/orden/get_ordenes_group.php",
              type: "POST",
              data: {
                tipo: function () { return $('#id_filtro_orden').val() },
                year: function () { return $('#id_year_registro').val() },
                pendiente: function () { return $('#chkPen').is(':checked') },
                aprobado: function () { return $('#chkApro').is(':checked') },
                compromiso: function () { return $('#chkCurC').is(':checked') },
                devengado: function () { return $('#chkCurD').is(':checked') },
                liquidacion: function () { return $('#chkLiq').is(':checked') },
                sinliquidacion: function () { return $('#chkSinLiq').is(':checked') },


                compras: function () { return $('#chkCompras').is(':checked') },
                presupuesto: function () { return $('#chkPresupuesto').is(':checked') },
                subdirector: function () { return $('#chkSubdirector').is(':checked') },
              },
              error: function () {
                $("#post_list_processing").css("display", "none");
              }
