...
Vue.component("pedidos-por-estado",{
  props: ["label","columna","verificacion","seleccionado","estado","id"],
  template: `
    <div :class="columna">
      <div class="form-group">
        <div class="">
          <div class="">
            ...
            <div class="input-group  has-personalizado" >
              <select :id="id" :name="id+'[]'" class="grupo_empleados js-select2 form-control form-control-sm input-sm pedidos_estado" multiple required style="width:100%" v-on:change="getValues">
          ...
          $.ajax({
            ...
            success: function (data) {
              if (data.msg == 'OK') {
                ...
                sendMail(emisor,receptor,body + ', '+$('#docto_obs').val());
                Swal.fire({
                  type: 'success',
                  title: data.message,
                  showConfirmButton: false,
...
Vue.component("acta-pedido", {
  props: ["ped_tra","verificacion","pedido","privilegio"],
  template: `
      <div v-if="privilegio.compras_tecnico == true">
            ...
            <form class="jsValidacionActaPedido" action='' method='' enctype='' id="formValidacionActaPedido">
              ...
              <empleados-listado columna="col-sm-6" verificacion="7999"></empleados-listado>
                ...
                <pedidos-por-estado estado="8148" columna="col-sm-12" id="id_ped_tra" label="Pedidos en cotización"></pedidos-por-estado>
                <campo row="col-sm-12" label="Observaciones:*" codigo="docto_obs" tipo="textarea" requerido="true"></campo>
                <div class="col-sm-12">
...
Vue.component("porcentaje-pedido", {
  ...
  <div class="col-sm-12" v-if="porcentaje.estado != ''">
    <div class="row">
      ...
      <div class="col-sm-12" v-if="porcentaje.ped_status == 8141 || porcentaje.ped_status == 8144">
        Motivo: <br>
  ...
  methods:{
    getPorcentaje: function(){
      axios.get('documentos/php/back/pedido/get_porcentaje_by_pedido', {
        ...
        if(this.porcentaje.ped_status == 8141 || this.porcentaje.ped_status == 8144){
...
Vue.component("renglones-listado",{
  ...
  <combo :row="columna" label="Renglón:*" codigo="id_renglon" :arreglo="renglones" tipo="3"></combo>
