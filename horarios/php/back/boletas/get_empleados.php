...
if (function_exists('verificar_session') && verificar_session() == true) {
  ...
  if ($u->hasPrivilege(297) && $u->hasPrivilege(298)) {
    ...
    foreach ($empleados as $empleado) {
      $vacaciones = 0;//$BOLETA->get_vacaciones_pendientes($empleado['id_persona']);
      $utilizados = 0;//$BOLETA->get_vacaciones_utilizadas($empleado['id_persona']);
      $pendientes = "";
      $tdias = 0;
      $thoras = 0;
      ...
      $dias = explode(";",$empleado['vacaciones']);
      ...
      $data[] = array(
        ...
        'pendientes' => $empleado['vacaciones'],//$pendientes . "<b>Total: " . $tdias .  " </b>",
