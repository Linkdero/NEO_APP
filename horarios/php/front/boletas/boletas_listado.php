            ...
            <div class="tab-content">
              <div id="vacaciones" class="tab-pane fade show active" role="tabpanel">
                <div class="table-responsive">
                  ...
                  <table id="tb_vacaciones" class="table table-actions table-striped table-bordered nowrap" width="100%">
                    <thead>
                      <div class="row">
                        <div class="col-sm-2">
                        ...
                        <div class="col-sm-1">
                          <p id="filter3"><label><b>Período:</b></label><br></p>
                        </div>
                        <div class="col-sm-1">
              ...
              <div id="reporte" class="tab-pane fade show" role="tabpanel">
                <div class="table-responsive">
                  ...
                  <table id="tb_reporte" class="table table-striped table-bordered  nowrap" width="100%">
                    <thead>
                      <tr>
              ...
              <div id='tabla' class='tab-pane fade'>
                ...
                <div class="row" style="margin-bottom: 15px;">
                  ...
                  <div class="col-sm-2">
                    <label for='diasua'>Días Utilizados en el Año:</label>
