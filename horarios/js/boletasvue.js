...
//formulario detalle
  viewModelBoletas = new Vue({
      ...
      methods: {
        ...
        getBoletas: function(){
          this.tableBoletas = $('#tb_vacaciones').DataTable({
              ...
              buttons: [
                  {
                      ...
                      className: 'btn btn-sm btn-personalizado btn-bo btn-bo1 active',
                  ...
                  },
                  {
                      ...
                      className: 'btn btn-sm btn-personalizado btn-bo btn-bo4',
                      action: function (e, dt, node, config) {
                          instanciaBV.recargarBoletas(4);
                          instanciaBV.tableBoletas.columns(8).visible(true);
                          instanciaBV.tableBoletas.column(8).order('asc');
                          document.getElementById("hidfechas").hidden = true;
                      }
                  },
                  {
                      text: '1 año <i class="fa fa-sync"></i>',
                      className: 'btn btn-sm btn-personalizado btn-bo btn-bo2',
                      action: function (e, dt, node, config) {
                  ...
                  },
                  {
                      ...
                      className: 'btn btn-sm btn-personalizado btn-bo btn-bo3',
                      action: function (e, dt, node, config) {
              ...
              initComplete: function () {
                  ...
                  var select = $('<select class=" form-control form-control-sm  form-control form-control-sm-sm"><option value="">TODOS</option></select>')
                      .appendTo('#filter2')
                      .on('change', function () {
                          var val = $(this).val();
                  ...
                  var column4 = this.api().column(11);
                  var select4 = $('<select class=" form-control form-control-sm  form-control form-control-sm-sm"><option value="">TODOS</option></select>')
                      .appendTo('#filter4')
                      .on('change', function () {
                          var val4 = $(this).val();
                  ...
                  var column5 = this.api().column(12);
                  var select5 = $('<select class=" form-control form-control-sm  form-control form-control-sm-sm"><option value="">TODOS</option></select>')
                      .appendTo('#filter5')
                      .on('change', function () {
                          var val5 = $(this).val();
                  ...
                  var column3 = this.api().column(9);
                  var select3 = $('<select class=" form-control form-control-sm  form-control form-control-sm-sm"><option value="">TODOS</option></select>')
                      .appendTo('#filter3')
                      .on('change', function () {
                          var val3 = $(this).val();
                          column3.search(val3).draw()
                      });
                  var offices3 = ['2022','2021', '2020', '2019', '2018', '2017', '2016'];
                  offices3.forEach(function (d) {
                      select3.append('<option value="' + d + '">' + d + '</option>');
                  })
                  var column1 = this.api().column(0);
                  var select1 = $('<select class=" form-control form-control-sm  form-control form-control-sm-sm"><option value="">TODOS</option></select>')
                      .appendTo('#filter1')
                      .on('change', function () {
                          var val1 = $(this).val();
              ...
              buttons: [
                  {
                      ...
                      className: 'btn btn-sm btn-personalizado',
                      action: function (e, dt, node, config) {
                        instanciaBV.reloadVacaciones(1);
                          //instreloadF(1);
                      }
                  },
                  {
                      ...
                      className: 'btn btn-sm btn-personalizado',
                      action: function (e, dt, node, config) {
                        instanciaBV.reloadVacaciones(0);
                          //reload_certs(0);
                      }
                  },
                  {
              ...
              buttons: [
                  {
                      ...
                      className: 'btn btn-sm btn-personalizado btn-bo',
                      action: function (e, dt, node, config) {
                          instanciaBV.RecargarReporte();
                          this.tableBoletas.columns(9).visible(false);
                      }
                  },
                  {
                      extend: 'excel',
        ...
        reloadVacaciones: function(tipo){
          $('#id_1_0').val(tipo);
          this.tableVacaciones.ajax.reload(null, false);
        },
