...
function update_vacaciones() {
    ...
    let daysapartados = parseInt($('#daysapartados').val());
    let daysdisponibles = parseInt($('#daysdisponibles').val());
            ...
            if (result.value) {
                $.ajax({
                    ...
                    data: {
                      ...
                      ddias: dds,
                      udias: count,
                      fsol: formatDate(fsol, "Y-m-d"),
                      fini: formatDate(fini, "Y-m-d"),
                      ffin: formatDate(ffin, "Y-m-d"),
                      fpre: formatDate(fpre, "Y-m-d"),
                      vobs: vobs,
                      daysapartados:daysapartados,
                      daysdisponibles:daysdisponibles
                    },
                    success: function (data) {
                        if (data.status == "200") {
                            Swal.fire({
...
function checkVacaciones(checkbox, dia_id, dias, horas, decs, daysapartados) {
    ...
    if (checkbox.checked) {
        ...
        dias = `<div class='col-sm-4'>
                    ...
                    <div class='col-sm-4'>
                        ...
                        <input type='hidden' value='${decs-daysapartados}' id='daysdisponibles'>
                        <input type='hidden' value='${daysapartados}' id='daysapartados'>
    ...
    var x = document.getElementsByClassName("litepicker")[0];
    // console.log(x.style);
    x.style["margin-top"] = "20px";
    x.style["margin-bottom"] = "20px";
    x.style["left"] = "49%";
