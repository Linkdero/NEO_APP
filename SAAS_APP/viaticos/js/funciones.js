                        ...
                        //alert(data);
                          ...
                          for(var x in valArray){
                            ...
                            $.ajax({
                              ...
                              //dataType: 'html',
                              data: { vt_nombramiento:vt_nombramiento, reng_num:reng_num, id_empleado:valArray[x], bln_cheque:bln_cheque },
                              success:function(data) {
                                  //alert(data);
                              }
                            }).done( function() {
      ...
      if (result.value) {
        $.ajax({
          ...
          success:function(data) {
              ...
              console.log(data);
              //$('#empleados_asignados_datos').html(data)
              if(estado==933 || estado==934 || estado==935 || estado==1635 || estado==936 || estado==163 || estado==938 || estado==1643){
