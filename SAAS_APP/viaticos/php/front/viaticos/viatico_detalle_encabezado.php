        ...
        <div class="row">
          ...
          <div class="col-sm-12">
            ...
            <div class="table-responsive">
              ...
              <div v-else-if="viaticos.status == 933"> <!-- Tiene que ser 933-->
                <?php if(usuarioPrivilegiado()->hasPrivilege(4)){?>
                  <script>
                  /*$(document).on("click", "#tb_montos tbody tr", function() {
                  ...
                  <div class="col-sm-12 text-right">
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <div v-else>
                          <input type="number" id="tasa_cambiaria" class="form-control input-sm form-corto text-right" placeholder="Tipo de Cambio"></input>
                        </div>
                      </div>
                      <div class="col-sm-6">
                    ...
                    <button id="" class="btn btn-info btn-sm" onclick="precesar_nombramiento(935)"><i class="fa fa-check"></i> Procesar </button>
                    <button id="" class="btn btn-danger btn-sm" onclick="au_solicitud(1635)"><i class="fa fa-times"></i> Anular </button>
                  </div>
                </div>
              ...
              <?php }?>
              <!--<div v-else-if="viaticos.status == 1635 || viaticos.status==1643">
                hello
              </div>
              <div v-else>
                adjfkl
                {{viaticos.autorizado_por}}
              </div>-->
