...
var EmpleadoDirectorio = function () {
    ...
    var initDatatableEmpleadoDirectorio = function () {
        tabla_directorio = $('#tb_acciones').DataTable({
            "ordering": false,
            "pageLength": 10,
            "bProcessing": true,
            "searching": true,
            ...
            "ajax": {
                url: "directorio/php/back/control/get_personas.php",
                type: "POST",
            ...
            "aoColumns": [
                ...
                { "class": "text-center", mData: 'Ultima' },
                { "class": "text-center", mData: 'TipoTrans' },
