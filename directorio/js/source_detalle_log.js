...
//         '<tr>'+
//             '<td>Full name:</td>'+
//             '<td>'+aData.valor_anterior+'</td>'+
//         '</tr>'+
//         '<tr>'+
//             '<td>Extension number:</td>'+
//             '<td>'+aData.valor_nuevo+'</td>'+
//         '</tr>'+
//         '<tr>'+
//             '<td>Extra info:</td>'+
...
var dataTableDetalle = function () {
    var initDatatableDetalle = function (id_persona) {
        ...
        tabla_detalle = $('#tb_detalle_telefono').DataTable({
            ...
            ajax: {
                url: "directorio/php/back/control/get_persona_log.php",
                type: "POST",
                // data:{ id_persona: $("#id_persona").val(),
                //         month: 11,
                //         year: 2020 },
                data: function (d) {
                    d.id_persona = $("#id_persona").val();
            ...
            "aoColumns": [
                { "class": "text-center", mData: 'descripcion_corta' },
                { "class": "text-center", mData: 'descrip_corta' },
                { "class": "text-center", mData: 'tipo_trans' },
                { "class": "text-center", mData: 'val_anterior' },
                { "class": "text-center", mData: 'val_nuevo' },
                { "class": "text-center", mData: 'fecha_mod' }
            ],
            "columnDefs": [
                {
                    "targets": [0],
            ...
            initComplete: function () {
                ...
                var offices1 = ['Actualización', 'Creación', 'Lectura', 'Eliminación'];
                offices1.sort();
        ...
        //     $('td:eq(0)', nRow).html('<a class="" href="#" ">'+aData.numero+'</a>').editable({
    ...
    return {
        init: function (id_dependencia, month, year) {
            var a = new Date();
