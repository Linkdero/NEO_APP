...
if (function_exists('verificar_session') && verificar_session() == true) :
  ...
  if ($valor != '') :
    ...
    $sql = "SELECT nombre FROM dir_detalle_contactos WHERE id_detalle = :id_detalle";
    ...
    $sql = "UPDATE dir_detalle_contactos SET nombre=?, id_usuario_mod=?, fecha_mod=? WHERE id_detalle=?
