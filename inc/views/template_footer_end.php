...
<div class="modal fade shadow" id="modal-remoto" role="dialog" data-backdrop="static" data-keyboard="false">
...
<!-- INICIO Modal Remoto-->
<div class="modal fade" id="modal-remoto-lg33" role="dialog" data-backdrop="static" data-keyboard="false">
...
<div class="modal fade " id="modal-remoto-lgg3" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-popout">
        <div class="modal-content">
            <!-- Contenido Remoto -->
            <div class='spinner-grow text-primary'></div>
...
<script src="<?php echo $one->assets_folder; ?>/js/plugins/select2/select2.min.js"></script>
...
<script type="" src="<?php echo $one->assets_folder; ?>/js/plugins/swal/sweetalert2@8"></script>
<script type="" src="<?php echo $one->assets_folder; ?>/js/plugins/swal/promise-polyfill"></script>
<link rel="stylesheet" href="<?php echo $one->assets_folder; ?>/js/plugins/swal/sweetalert2.min.css">
<script src="<?php echo $one->assets_folder; ?>/js/pages/logos.js"></script>
<!-- Page JS Code-->

<script src="<?php echo $one->assets_folder; ?>/js/plugins/datatables/dataTables.bootstrap4.min.js"></script>
<script src="assets/js/plugins/datatables/dataTables.bootstrap4.min.js"></script>
<script src="assets/js/plugins/datatables/dataTables.fixedColumns.min.js"></script>
<script src='assets/js/plugins/datatables/new/dataTables.checkboxes.min.js'></script>
<script src="<?php echo $one->assets_folder; ?>/js/plugins/x-editable/bootstrap-editable.min.js"></script>
<script src="<?php echo $one->assets_folder; ?>/js/plugins/x-editable/bootstrap-editable.js"></script>
<script src='assets/js/plugins/datatables/new/dataTables.checkboxes.min.js'></script>
<script src="<?php echo $one->assets_folder; ?>/js/plugins/vue-pdf/vue-pdf.js"></script>
    ...
    $(document).ready(function() {
        ...
        $(document).ready(function() {
            $(".modal").on("hidden.bs.modal", function() {
                ...
                //$(".modal-body").html("");
                $(".modal-body").html("<div class='spinner-grow text-primary'></div>");
            });
        });
    });
</script>
...
<!-- funciones insumoes egreso -->
<script>
    $('#modal-remoto-lg').on('click', '.empleado-egreso', function() {
    ...
    $('#modal-remoto-lg').on('click', '.empleado-autoriza', function() {
        var value = $('#myPopupInput1').val();
        $('#id_persona_autoriza').val(value);
        get_empleado_autoriza(5555, 0);
        $('#modal-remoto-lg').modal('hide');
        Swal.fire({
            type: 'success',
            title: 'Empleado agregado',
    ...
    $('#modal-remoto-lgg3').on('click', '.insumo-agregar', function() {
        var value = $('#myPopupInput').val();
        $('#serie').val(value);
        agregar_insumo();
    });
    $('#modal-remoto-lgg3').on('hidden.bs.modal', function(e) {
