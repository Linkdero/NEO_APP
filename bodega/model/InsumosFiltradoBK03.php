...
$privilegio = Requisicion::getPrivilegios(2);
//sec_session_start();
if (function_exists('verificar_session') && verificar_session() == true) :
  ...
  $sql0 = "SELECT  a.Pro_idint, a.Ent_id, a.Pro_des, a.Med_id, c.Med_nom, b.Bod_id
          ...
          WHERE b.bod_id = ? AND a.Pro_des LIKE '%".$_GET['q']."%'
          ";
  ...
  if($bodega_id == '01'){
    if($privilegio['residencias_solicita_cocina'] == 1){
      ...
      $sql0 .=" AND a.Pro_idint IN (4372,9468,791,4269,6994,6250,5727,864,5875,5652,765,6813,802,5659)";
    }
  }
