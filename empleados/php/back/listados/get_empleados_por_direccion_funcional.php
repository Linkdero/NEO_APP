    ...
    if($moduloF){
      ...
      foreach($empleados as $empleado){
        ...
        $sub_array = array(
          ...
          'accion'=>'<span class="btn btn-sm btn-personalizado outline" data-toggle="modal" data-target="#modal-remoto-lgg2" href="empleados/php/front/puestos/detalle_puesto?id_persona='.$empleado['id_persona'].'&tipo=1"><i class="fa fa-check"></i></span>'
