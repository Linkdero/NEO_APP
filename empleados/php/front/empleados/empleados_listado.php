...
<script src="assets/js/plugins/jspdf/fonts/fontawesome.js"></script>
<script src="assets/js/plugins/jspdf/fonts/logo_transparente.js"></script>
<script src="assets/js/plugins/jspdf/empleados/ficha.1.6.js"></script>
        ...
        <div class="col-md-12 mb-12 mb-md-0">
          <div class="card h-100">
            <header class="card-header d-flex align-items-center">
              <h2 class="h3 card-header-title">Empleados</h2>
              ...
              <ul class="list-inline ml-auto mb-0">
                ...
                <li class="nav-item mr-4">
                  <?php if(evaluar_flag($_SESSION['id_persona'],1163,70,'flag_actualizar')==1){?>
                    <li class="list-inline-item" data-toggle="tooltip" title="Crear Empleado">
                      <span class="link-muted h3" data-toggle="modal" data-target="#modal-remoto-lg" href="empleados/php/front/empleados/empleado_nuevo.php">
          ...
          <div id="imagen"></div>
            ...
            $("#data").val('');
              ...
              <div class="">
                ...
                <input id="tipo_reload" value="1" hidden></input>
