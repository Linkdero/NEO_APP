...
Vue.component("form-asignacion-contrato",{
  ...
  template:`
    ...
    <input id="tipo_de_accion" name="tipo_de_accion" v-bind:value="tipo_accion" hidden></input>
      <div class="row">
        ...
        <campo row="col-sm-3" :label="tituloSueldo" codigo="id_monto_ct_mensual" tipo="number" requerido="true" :valor="contrato.monto_mensual"></campo>
          ...
          <div class="form-group">
            <div class="">
              <div class="">
                ...
                <div class=" input-group  has-personalizado" >
                  <select id="id_tipo_contrato_ct" name="id_tipo_contrato_ct" class="form-control form-control-sm form-control-alternative" required v-model="contratoTipo" @change="showTipoServicio($event)">
        ...
        <combo v-if="tipoServicio == 9" codigo="tipo_de_servicio_ct" :arreglo="arrayTipoS" requerido="true" tipo="3" label="Tipo de servicio" row="col-sm-3" :valor="servicioTipo"></combo>
        ...
        <!-- fin -->
        <!-- inicio -->
        <accion confirmacion="1" cancelar="2" v-on:event_child="eventAccion" v-if="statusContrato == true"></accion>
        <div class="col-sm-12 text-right" v-if="statusContrato == false">
        <span class="btn btn-sm btn-danger" @click="regresarListado" ><i class="fa fa-times-circle"></i> Regresar</span>
        </div>
  ...
  data(){
    return {
      ...
      servicioTipo:"",
      tipoServicio:"",
      tituloSueldo:"Honorarios mensuales",
      statusContrato:true,
      arrayTipoS:[{'id_item':"",'item_string':'-- Seleccionar --'},{'id_item':1,'item_string':'Servicios Técnicos'},{'id_item':2,'item_string':'Servicios Profesionales'}]
    }
  },
  mounted: function() {
  },
  methods:{
    regresarListado: function(){
    ...
    getAsignacionContrato: function(){
      if(this.tipo_accion == 2){
        axios.get('empleados/php/back/contratos/contrato_por_asignacion.php', {
          ...
          this.contratoTipo = this.contrato.tipo_contrato;
          this.tipoServicio = this.contratoTipo;
          this.servicioTipo = this.contrato.id_tipo_servicio;
          this.tituloSueldo = (this.tipoServicio == 8) ? 'Sueldo diario:*' : this.tituloSueldo;
          this.statusContrato = (this.contrato.id_status == 908) ? true : false;
    ...
    showTipoServicio: function(event){
      this.tipoServicio = event.currentTarget.value;
      this.tituloSueldo = (this.tipoServicio == 8) ? 'Sueldo diario:*' : "Honorarios mensuales:*";
    },
...
Vue.component("form-asignacion-apoyo",{
  props:["id_persona","id_empleado","id_reng_num","tipo_accion","tipo"],
  template:`
    <form class="jsValidationAsignacionApoyo" id="formAsignacionApoyo">
    <h3 v-if="tipo_accion==1 && tipo == 1">Asignar personal de apoyo</h3><h3 v-else-if="tipo_accion==2 && tipo == 1">Actualizar Asignación</h3><br>
    <h3 v-if="tipo_accion==1 && tipo == 2">Asignar personal practicante</h3><h3 v-else-if="tipo_accion==2 && tipo == 2">Actualizar Practicante</h3><br>
    <input id="id_gafete" name="id_gafete" :value="id_persona" hidden></input>
    <input id="id_empleado" name="id_empleado" :value="id_empleado" hidden></input>
    <input id="reng_num" name="reng_num" v-if="tipo_accion == 2" v-bind:value="id_reng_num" hidden></input>
    <input id="tipo_de_accion" name="tipo_de_accion" v-bind:value="tipo_accion" hidden></input>
    <input id="tipo_ingreso" name="tipo_ingreso" v-bind:value="tipo" hidden></input>
      <div class="row">
        <!-- fin-->
        ...
        <div class="col-sm-12" v-if="tipo == 1">
          <div class="row">
            ...
            <campo row="col-sm-3" label="Partida presupuestaria" codigo="partida" tipo="text" requerido="false" :valor="apoyo.partida"></campo>
            <campo row="col-sm-3" label="Salario base*" codigo="salario_base" tipo="number" requerido="true" :valor="apoyo.salario_base"></campo>
            <campo row="col-sm-3" label="Bonificación*" codigo="bonificacion" tipo="number" requerido="true" :valor="apoyo.bonificacion"></campo>
        ...
        <div class="row slide_up_anim">
          ...
          <div class="col-sm-12" v-if="tipo == 1">
            <span class="numberr">1</span><strong class=""> Datos del Funcionales</strong><br>
          </div>
          <!-- inicio component -->
          <div>
            ...
            if (result.value) {
              ...
              $.ajax({
                ...
                success:function(data){
                  ...
                  Swal.fire({
                    type: 'success',
                    title: 'Personal de apoyo ingresado',
                    showConfirmButton: false,
                    timer: 1100
                  });
                  //alert(data);
    ...
    <div v-if="opcion==13">
      ...
      <input id="id_tipo_aspirante" name="id_tipo_aspirante" :value="seleccion" hidden></input>
        <div class="row">
          ...
          <div class="col-sm-3" v-if="seleccion == 1 || seleccion == 2 || seleccion == 3">
            <div class="form-group">
...
Vue.component("form-nuevo-curso", {
  ...
  <!--{{tipoc}}-->
    <form class="jsValidacionCursoNuevo" id="formValidacionCursoNuevo">
      <div class="row">
        <combo-items col="col-sm-12" label="Tipo de Curso*" codigo="id_tipo_curso" id_catalogo="11" ></combo-items>
        <combo-items col="col-sm-12" label="Centro de Capacitación*" codigo="id_centro_capacitacion" id_catalogo="32"></combo-items>
