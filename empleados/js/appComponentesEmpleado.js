        ...
        <div class="el-wrapper" v-for="p in plazas">
          ...
          <div class="box-down">
            ...
            <div class="row" style="margin-top:-5px">
              ...
              <small>{{ p.remocion_reingreso }}<small>
              ...
              <div class="row">
                <div class="col-sm-12" v-if="datos_plaza.emp_estado==891">
                  <form class="js-validation-tramite-solvencia form-material">
                    <div class="row">
                      <!--inicio-->
                      <combo row="col-sm-12" label="Tipo de baja*" codigo="id_tipo_baja_bj" :arreglo="items" tipo="2" requerido="true"></combo>
                      ...
                      <campo row="col-sm-4" label="Fecha de Baja*" codigo="id_fecha_remocion_re" tipo="date" requerido="true"></campo>

                      <!--<campo row="col-sm-6" label="Fecha efectiva de baja*" codigo="id_fecha_baja_bj" tipo="date" requerido="true"></campo>-->

                      <campo row="col-sm-12" label="Detalle*" codigo="id_detalle_remocion_re" tipo="textarea" requerido="true"></campo>

                      <checkbox row="col-sm-6" label="Remoción reingreso" codigo="remocion_reingreso" style="height:5px;margin-top:-25px"></checkbox>
            ...
            <div class="card-body">
              ...
              <form class="js-validation-finalizacion-contrato form-material">
                ...
                <input id="reng_num" :value="reng_num" hidden></input>
                  ...
                  <campo row="col-sm-4" label="No. Acuerdo*" codigo="id_nro_acuerdo_fc" tipo="text" requerido="false"></campo>
