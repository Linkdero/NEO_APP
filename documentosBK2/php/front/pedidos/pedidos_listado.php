...
?>
    ...
    <script src="documentos/js/pedidos_vue_2.8.js"></script>
    <script src="assets/js/plugins/push/push.min.js"></script>

    <script src="assets/js/plugins/jspdf/jspdf.js"></script>
    <?php if (usuarioPrivilegiado()->hasPrivilege(302)){?>
    <script src="assets/js/plugins/jspdf/jspdf.1.5.js"></script>
  <?php }?>
    <script src="assets/js/plugins/jspdf/documentos/impresiones_1.4.js"></script>
