...
if (function_exists('verificar_session') && verificar_session() == true) :
    ...
    $empspantalla = array();
    $empspantalla=configuracion::get_empspantallas($pantalla);
    $data = array();

    foreach ($empspantalla as $e){
      $status='';
      if($e['id_activo']==0){
      ...
      if($e['estado_acceso']==1119){
        ...
        <input id="'.$e['id_persona'].'4" class="custom-control-input"';
        ...
        <label class="custom-control-label" for="'.$e['id_persona'].'4"></label>
        </div>';
        //fin

        //inicio
        $chk5.='<div class="custom-control custom-checkbox text-center">
        <input id="'.$e['id_persona'].'5" class="custom-control-input"';
        ...
        <label class="custom-control-label" for="'.$e['id_persona'].'5"></label>
        </div>';
        //fin

        //inicio
        $chk6.='<div class="custom-control custom-checkbox text-center">
        <input id="'.$e['id_persona'].'6" class="custom-control-input"';
        ...
        <label class="custom-control-label" for="'.$e['id_persona'].'6"></label>
        </div>';
        //fin

        //inicio
        $chk7.='<div class="custom-control custom-checkbox text-center">
        <input id="'.$e['id_persona'].'7" class="custom-control-input"';
        ...
        <label class="custom-control-label" for="'.$e['id_persona'].'7"></label>
        </div>';
        //fin

        //inicio
        $chk8.='<div class="custom-control custom-checkbox text-center">
        <input id="'.$e['id_persona'].'8" class="custom-control-input"';
        ...
        <label class="custom-control-label" for="'.$e['id_persona'].'8"></label>
        </div>';
        //fin
