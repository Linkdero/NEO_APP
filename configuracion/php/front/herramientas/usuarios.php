<?php if (function_exists('verificar_session') && verificar_session()): ?>
    <?php if(usuarioPrivilegiado_acceso()->accesoModulo(7851)): ?>
        ...
        <script src="configuracion/js/source_usuarios.js"></script>
                    ...
                    <div class="col-md-12 mb-12 mb-md-0">
                        <div class="card">
                            <header class="card-header d-flex align-items-center">
                                <h2 class="h3 card-header-title">USUARIOS DEL SISTEMA</h2>
                            ...
                            <div class="card-body card-body-slide">
                                ...
                                <table id="tb_catalogo" class="table table-striped table-hover" width="100%">
                                    ...
                                    <th class="text-center text-dark"><h3><strong>Dirección</strong></h3></th>
                                    <th class="text-center text-dark"><h3><strong>Puesto</strong></h3></th>
                                    <th class="text-center text-dark"><h3><strong>Usuario</strong></h3></th>
                                    <th class="text-center text-dark"><h3><strong>Estado</strong></h3></th>
                                    <th class="text-center text-dark"><h3><strong>Validación</strong></h3></th>
