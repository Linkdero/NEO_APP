...
var Catalogo = function() {
    ...
    var initDatatableCatalogo = function() {
      tabla_catalogo = $('#tb_catalogo').DataTable({
        ...
        "ajax":{
            url :"configuracion/php/back/herramientas/get_catalogo.php",
            type: "POST",
            error: function(){
           ...
           "aoColumns": [
             { "class" : "text-center", mData: 'id_catalogo'},
             { "class" : "text-center", mData: 'cdescripcion'},
             { "class" : "text-center", mData: 'ccomentario'},
             { "class" : "text-center", mData: 'ddescripcion' },
             { "class" : "text-center", mData: 'dcomentario' },
             { "class" : "text-center", mData: 'id_item' }
           ],

           "columnDefs": [
                {   "targets": 1,
                    "render": function (data, type, full, meta) {
                        return type === 'display' ? '<div title="' + full.ccomentario + '">' + data : data;
                    },

                },
                {   "targets": 3,
                    "render": function (data, type, full, meta) {
                        return type === 'display' ? '<div title="' + full.dcomentario + '">' + data : data;
                    },
          ...
          initComplete: function() {
            ...
            var select = $('<select class="form-control chosen-select"><option value="">TODOS</option></select>')
              .appendTo('#filter1')
              .on('change', function() {
                var val = $(this).val();
