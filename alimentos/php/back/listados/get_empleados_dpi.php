...
if (function_exists('verificar_session') && verificar_session() == true) :
    ...
    $empleados = array();
    $empleados = empleado::get_empleados_ficha();
    $data = array();
    ...
    foreach ($empleados as $e){
      ...
      $sub_array = array(
        ...
        'empleado'=>$e['primer_nombre'].' '.$e['segundo_nombre'].' '.$e['tercer_nombre'],
        'email'=>$e['primer_apellido'].' '.$e['segundo_apellido'].' '.$e['tercer_apellido'],
