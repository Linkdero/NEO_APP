...
<head>
  ...
  <script src="documentos/js/factura_vue_1.3.js" ></script>
...
<div id="app_factura_n">
  ...
  <div class="modal-body">
    ...
    <div v-show="sopcion == 1">
      <form class="jsValidacionFacturaNueva">
        <!-- inicio factura -->
        <div class="row">
          <!--inicio-->
          <div class="col-sm-6">
            ...
            <div class="form-group">
              <div class="">
                <div class="">
                  ...
                  <div class=" input-group  has-personalizado" >
                    <input type="number" oninput="this.value = this.value.toUpperCase()" maxlength="50" class="form-control form-control_ input-sm" id="factura_monto" name="factura_monto" placeholder="@Monto" required autocomplete="off" min="1"/>
                  </div>
                </div>
              </div>
            </div>
