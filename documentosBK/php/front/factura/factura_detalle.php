      ...
      <div>
        <div class="row">
            ...
            <div class="card" >
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12" >
                    <dato-persona icono="far fa-calendar-check" texto="Fecha:" :dato="factura.factura_fecha" tipo="0"></dato-persona>
                    <dato-persona icono="fa fa-calendar-check" texto="Nit del Proveedor:" :dato="factura.proveedor_nit" tipo="0"></dato-persona>
                    <dato-persona icono="fa fa-file-invoice" texto="Serie:" :dato="factura.factura_serie" tipo="0"></dato-persona>
                    <dato-persona icono="fa fa-receipt" texto="Número:" :dato="factura.factura_num" tipo="0"></dato-persona>
                    <dato-persona icono="fa fa-calendar-check" texto="Razón Social:" :dato="factura.proveedor" tipo="0"></dato-persona>
                  </div>
                </div>
                  <!-- fin -->
              </div>
              ...
              <div class="card-footer bg-muted" style="background: transparent">
                <div class="row">
                  ...
                  <div class="col-sm-9 text-right">
                    <h2 class="">{{ factura.factura_total }}</h2>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-sm-8" v-if="asignarF == 1">
            <div class="card card-body" style="height:360px">
              <asignar-tecnico columna="col-sm-12" option="1" :orden_id="orden_id" :privilegio="privilegio"></asignar-tecnico>
              <hr>
          ...
          <div class="col-sm-8" v-if="asignarF == 2">
            <div class="card " style="height:360px">
              <factura-estado columna="col-sm-12" option="1" :orden_id="orden_id" :factura="factura"></factura-estado>
