...
if (function_exists('verificar_session') && verificar_session() == true) :
  ...
  foreach ($listado as $l) {
    ...
    $progress .= '<div style="margin-top:0px; "><span class="badge-sm text-' . $l['color'] . '">' . $l['estado'] . '<br>' . $l['verificacion'] . '</span>';
    ...
    $accion .= '<a id="actions1Invoker1" class=" btn btn-soft-info btn-sm" href="#!" aria-haspopup="true" aria-expanded="false"data-toggle="dropdown" onclick="get_menu_impresion(' . $l['ped_tra'] . ',1)"><i class="fa fa-print"></i></a>
      <div class="dropdown-menu dpm1 dropdown-menu-right border-0 py-0 mt-3 slide-up-fade-in" style="width: 260px;" aria-labelledby="actions1Invoker1" style="margin-right:20px"><div class="card overflow-hidden" style="margin-top:-20px;"><div class="card-header d-flex align-items-center py-3"><h2 class="h4 card-header-title">Opciones:</h2></div><div  class="card-body animacion_right_to_left" style="padding: 0rem;"><div id="menu' . $l['ped_tra'] . '1"></div></div></div></div>';
    $accion .= '</div><div class="">';
    $accion .= '<a id="actions1Invoker2" class=" btn btn-soft-info btn-sm" href="#!" aria-haspopup="true" aria-expanded="false"data-toggle="dropdown" onclick="get_menu_impresion(' . $l['ped_tra'] . ',2)"><i class="far fa-file"></i></a>
      <div class="dropdown-menu dpm2 dropdown-menu-right border-0 py-0 mt-3 slide-up-fade-in" style="width: 260px;" aria-labelledby="actions1Invoker2" style="margin-right:20px"><div class="card overflow-hidden" style="margin-top:-20px;"><div class="card-header d-flex align-items-center py-3"><h2 class="h4 card-header-title">Opciones:</h2></div><div  class="card-body animacion_right_to_left" style="padding: 0rem;"><div id="menu' . $l['ped_tra'] . '2"></div></div></div></div>';
