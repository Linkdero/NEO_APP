...
";
  ...
  static function get_facturas($tipo)
  {
    ...
    $sql0 = "SELECT a.orden_compra_id, a.nro_orden, a.year, a.tipo_pago, a.status, a.asignado_en, a.asignado_por,b.ped_tra, a.reng_num,
                    ...
                    ISNULL(e.segundo_apellido, '')+ ' '+ISNULL(e.tercer_apellido, '') AS empleado, a.clase_proceso, ISNULL(a.factura_publicada, '') AS factura_publicada
            ...
            if($tipo == 0){//pendientes
              $sql0 .= "WHERE YEAR(a.asignado_en) = 2022 AND ISNULL(a.modalidad_pago,0) = 0 AND ISNULL(a.factura_publicada,0) = 0 OR YEAR(a.asignado_en) = 2022 AND ISNULL(a.modalidad_pago,0) = 2 AND ISNULL(a.cur,0) = 0 AND ISNULL(a.factura_publicada,0) = 0";
            }else
            if($tipo == 1){ //deuda
            ...
            if($tipo == 4){ //liquidadas acreditamiento
              $sql0 .= ' WHERE YEAR(a.asignado_en) = 2022 AND a.factura_publicada = 1 AND ISNULL(a.cur,0) = 0 AND ISNULL(a.cur_devengado,0) = 0';
            }
  ...
  static function get_ordenes_pendientes($tipo)
  {
    ...
    $sql0 = "SELECT nro_orden FROM docto_ped_pago
             WHERE YEAR(asignado_en) = '2022' AND ISNULL(nro_orden,0) > 0 ";
