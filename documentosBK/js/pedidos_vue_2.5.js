      ...
      table_facturas: function () {
        this.tableFacturas = $('#tb_facturas').DataTable({
          ...
          buttons: [
            ...
            {
              text: 'Pendientes <i class="fa fa-sync btn-f1"></i>',
              className: 'btn btn-soft-info btn-sm',
              action: function (e, dt, node, config) {
                viewModelPedido.recargarFacturas(0);
              }
            },
            {
              text: 'Deudas <i class="fa fa-sync btn-f2"></i>',
              className: 'btn btn-soft-info btn-sm',
              action: function (e, dt, node, config) {
                viewModelPedido.recargarFacturas(1);
              }
            },
            {
              text: 'Liquidadas <i class="fa fa-sync btn-f3"></i>',
              className: 'btn btn-soft-info btn-sm',
              action: function (e, dt, node, config) {
                viewModelPedido.recargarFacturas(2);
              }
            },
            {
              text: 'Anuladas <i class="fa fa-sync btn-f4"></i>',
              className: 'btn btn-soft-info btn-sm',
              action: function (e, dt, node, config) {
                viewModelPedido.recargarFacturas();
              }
            },
            {
