...
if (function_exists('verificar_session') && verificar_session() == true) :
  ...
  $fecha_liquidacion=date('Y-m-d H:i:s');//date('Y-m-d', strtotime($_POST['id_fecha_liquidacion']));
  ...
  try{
    ...
    foreach ($empleados as $e){
      ...
      if($e['bln_confirma']==1){
        ...
        /*$sql2 = "UPDATE vt_nombramiento_detalle SET otros_gastos=? WHERE vt_nombramiento=? AND reng_num =?";
        $q2 = $pdo->prepare($sql2);
        $q2->execute(array($otros_gastos,$vt_nombramiento,$e['reng_num']));*/
  ...
  */
    //fin
    $yes = array('msg'=>'OK','message'=>'Nombramiento liquidado');
