...
<head>
  ...
  <script src="viaticos/js/funciones_1.4.js"></script>
...
<body>
  ...
  <div id="" class="modal-body">
    ...
    <div class="stepwizard col-sm-12" hidden disabled>
      ...
      <input id="id_cambiov" hidden></input>
              ...
              <div class="form-group">
                <div class="">
                  <div class="row">
                    ...
                    <div class=" " >
                      <textarea rows="3" type="text" oninput="this.value = this.value.toUpperCase()" class=" form-control form-control_  form-control-sm" id="observaciones" name="observaciones" placeholder="Observaciones" required autocomplete="off">Ninguna</textarea>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="">
                  <div class="row">
                    ...
                    <div class=" input-group  has-personalizado" >
                        <select class="form-control input-lg form-control_  form-control-sm" id="id_funcionario">
                          <?php
            ...
            <div class="form-group">
              <div class="">
                <div class="row">
                  ...
                  <div class=" input-group  has-personalizado" >
                      <select class="form-control input-lg form-control_  form-control-sm " id="pais">
                        <?php
