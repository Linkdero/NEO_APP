                ...
                confirmButtonText: '¡Si, Guardar!'
                  ...
                  if (result.value) {
                    $.ajax({
                      type: "POST",
                      dataType: 'json',
                      url: "viaticos/php/back/viatico/crear_viatico.php",
                      //dataType: 'html',
                      ...
                      success:function(data) {
                        //alert(data);
                          ...
                          for(var x in valArray){
                            ...
                            $.ajax({
                              type: "POST",
                              url: "viaticos/php/back/viatico/crear_viatico_detalle.php",
                              //dataType: 'html',
                              data: { vt_nombramiento:vt_nombramiento, reng_num:reng_num, id_empleado:valArray[x], bln_cheque:bln_cheque, direccion:data.direccion },
                              success:function(data) {
                                  //alert(data);
                              }
                            }).done( function() {
...
function precesar_nombramiento(estado, event){
  ...
  if(nFilas_total>0){
    ...
    if($('#pais_tipo').text()=='Extranjero' || $('#pais_tipo').text()=='EXTERIOR'){
      ...
      if($('#sub_total').text()==0){
        estado=7959;
        event.preventDefault();
        generarNombramiento(formulario,estado,cambio)
...
function generarNombramiento(formulario,estado,cambio){
