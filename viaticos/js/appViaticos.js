...
//import { viewModelViaticoDetalle } from './appViaticos.js';

$(document).ready(function(){
  var instancia;
  const viewModelViatico = new Vue({
    el: '#appViatico',
    tableViaticos:"",
    bsDataTables:"",
    api:"",
            ...
            "columnDefs": [
              ...
              },
              {
                ...
                render: function(data, type, row, meta) {
                  ...
                  //return  '<div class="btn-group">'+menu+'<span class="btn btn-sm btn-personalizado outline" data-toggle="modal" data-target="#modal-remoto-vt"><i class="fa fa-pencil-alt" aria-hidden="true"></i></span></div>';//'+row.DT_RowId+'
                  return  '<div class="btn-group">'+menu+'<span class="modalViatico btn btn-sm btn-personalizado outline" id="idViaticoDetalle" data-id="'+row.DT_RowId+'"><i class="fa fa-pencil-alt" aria-hidden="true"></i></span></div>';//'+row.DT_RowId+'
              }
            }
          ]
        });

        $(document).on("click", "#idViaticoDetalle", function(){
          thisInstance.showModal($(this).attr("data-id"));
        })
...
//})
  ...
  $('#modal-remoto-lg').on('hidden.bs.modal', function (e) {
    ...
    if(valor == 2){
      ...
      viewModelViatico.recargarViaticos(tipo,'btn-v1');
    }
