...
var mes = fechaActual.getMonth() + 1; // Ajusta el mes (los meses comienzan desde 0)
...
// Convierte el mes a texto
var nombresMeses = [
  "Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio",
  "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"
];
var nombreMes = nombresMeses[mes - 1]; // Ajusta el índice del array

// Construye la cadena de la fecha
var fechaFormateada = dia + " de " + nombreMes + " de " + anio;
let horaFormateada = horas + ":" + minutos + ":" + segundos
// Muestra la fecha
console.log('Impresion Realizada el: ' + fechaFormateada);
      ...
      if(pagina == 1){
        ...
        doc.writeText(205, 335, 'Impresión Realizada el: '+fechaFormateada, { align: 'right', width: 5 });
        doc.writeText(205, 338, 'Hora: '+horaFormateada, { align: 'right', width: 5 });
      ...
      doc.setFont("MontserratSemibold");
      doc.setFontSize(14);
      var tituloSueldo = 'Sueldo';
      if(data.renglon == '029'){
        doc.setFontSize(10);
        tituloSueldo = 'Honorarios';
      }
      
      doc.text(160, 180, tituloSueldo);
      doc.setFont('PoppinsBold')
      doc.setFontSize(14);
