                ...
                if(data.data[i].descripcion_lugar == 0 || data.data[i].descripcion_lugar == 1){
                  ...
                  for(nombreIndice in data.data[i].destinos){
                    ...
                    if(nombreIndice == 0){
                      ...
                      doc.setFontType("normal");
                      doc.text(140, punto+45, data.data[i].destinos[nombreIndice].h_ini);
                      doc.text(160, punto+45, data.data[i].fecha_salida);
                    }


                    doc.text(35, punto+50, 'Hora de llegada a : ');
                    doc.text(65, punto+50, data.data[i].destinos[nombreIndice].dep);
                    doc.text(140, punto+50, data.data[i].destinos[nombreIndice].h_ini);
                    doc.text(160, punto+50, data.data[i].destinos[nombreIndice].f_ini);

                    doc.text(35, punto+55, 'Hora de Salida de : ');
                    doc.text(65, punto+55, data.data[i].destinos[nombreIndice].dep);
                    doc.text(140, punto+55, data.data[i].destinos[nombreIndice].h_fin);
                    doc.text(160, punto+55, data.data[i].destinos[nombreIndice].f_fin);
