      ...
      for (var i = 0; i < data.data.length; i++) {
        ...
        if (data.data[i].descripcion_lugar == 2) {
          for (nombreIndice in data.data[i].destinos) {
            ...
            doc.setFontSize(7);
            doc.writeText(93, punto_destino, data.data[i].destinos[nombreIndice].f_ini, { align: 'center', width: 30 });
            doc.writeText(77, punto_destino, data.data[i].destinos[nombreIndice].h_ini, { align: 'center', width: 30 });
            doc.writeText(128, punto_destino, data.data[i].destinos[nombreIndice].f_fin, { align: 'center', width: 30 });
            doc.writeText(111, punto_destino, data.data[i].destinos[nombreIndice].h_fin, { align: 'center', width: 30 });
