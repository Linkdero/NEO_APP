function justificacion_reporte(docto_id) {
  $.ajax({
    ...
    success: function (data) {
      ...
      doc.roundedRect(20, punto, 175, lineas_e, 1, 1);
      punto += lineas_e + 5;
      ...
      punto += 3;
      doc.roundedRect(20, punto, 175, 12, 1, 1);
...
function imprimirPedidoF(ped_tra, p) {
  $.ajax({
    type: "POST",
    ...
    success: function (data) {
      ...
      doc.writeText(65, punto + 52, 'SECRETARIA DE ASUNTOS ADMINISTRATIVOS Y DE SEGURIDAD', { align: 'left', width: 195 });
      doc.writeText(35, punto + 60, '13 SEGURIDAD PRESIDENCIAL Y VICEPRESIDENCIAL', { align: 'left', width: 195 });
      ...
      doc.writeText(40, punto + 85, 'DEPARTAMENTO DE COMPRAS', { align: 'left', width: 195 });
      /*doc.writeText(5,40,data.correlativo,{align:'right',width:195});
      doc.writeText(5,45, data.pedido_num,{align:'right',width:195});*/
